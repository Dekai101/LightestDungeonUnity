...
public class StateBossRoom extends State {
    ...
    public StateBossRoom(GameInstance game) {
        super(game);
    ...
    private void waitAllPlayers(Player p, JSONMessage jsonMsg) {
        ...
        if (allCleared) {
            ...
            game.broadcast(new JSONMessage(game.getId(), new Message_OUT("You win!", "GAME_WIN")));
            game.stop();
        }
    }
